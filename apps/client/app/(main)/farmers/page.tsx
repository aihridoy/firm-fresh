        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-3">
                <i className="fas fa-map-marker-alt mr-2"></i>Khulna, Bangladesh
              </p>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Specializes in honey production and medicinal herbs. Maintains
                bee colonies and organic herb gardens.
              </p>
              <div className="flex items-center justify-between mb-4">
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  <span className="font-medium">Farm Size:</span> 4 acres
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">
