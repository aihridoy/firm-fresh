        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
            ...
            <form className="space-y-6" action="success.html" method="POST">
              ...
              <button
                type="submit"
                className="w-full bg-primary-600 hover:bg-primary-700 text-white py-3 px-4 rounded-lg font-medium text-lg transition duration-200 transhtmlForm hover:scale-105"
              >
              ...
              <div className="flex items-center justify-center text-sm text-gray-500 dark:text-gray-400">
                ...
                Your payment inhtmlFormation is secure and encrypted
              </div>
            </form>
          </div>
        </div>
